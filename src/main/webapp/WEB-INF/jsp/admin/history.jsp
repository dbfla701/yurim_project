...
<body>
    <%@ include file="/WEB-INF/views/header.jsp" %>
		...
		<ul class="nav nav-tabs nav-justified">
			<li role="presentation"><a href="/admin/loginAfter.do">회원 관리</a></li>
			<li role="presentation" class="active"><a href="/admin/history.do">로그인 기록</a></li>
		</ul>
	</div>
	<br>
	...
	<div class="bs-example" data-example-id="condensed-table"
		...
		<h3 style="font-weight: bold; margin-bottom: 20px;">로그인 기록</h3>
